...
public class WebDriverEngine {
	...
	public boolean isTextPresent(String pattern) {//验证页面上面是否存在你输入的文本内
	...
	public String getText(String locator) {//获取当前driver对象的text值ֵ
	...
	public String getValue(String locator) {//获取value属性值ֵ
