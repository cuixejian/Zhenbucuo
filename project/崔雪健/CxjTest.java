...
import demo1.JavaMailTestListener;
import demo1.MailUtil2;
...
public class CxjTest extends BaseTest {	
	...
	public Object[][] data() throws IOException{
		...
		return excel.getTestDataByExcel("d:\\2020year\\eclipse-workspace\\Tsshop\\data\\data1.xlsx", "Sheet1");
	}
	@BeforeSuite
...
//    	 MailUtil sendMail =new MailUtil(JavaMailTestListener.aString);
    	MailUtil2 sMai = new MailUtil2(JavaMailTestListener.aString);
    }
}
